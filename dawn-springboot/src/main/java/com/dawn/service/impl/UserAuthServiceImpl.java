...
import com.dawn.service.UserAuthService;
import com.dawn.strategy.context.SocialLoginStrategyContext;
...
import static com.dawn.constant.RabbitMQConstant.EMAIL_EXCHANGE;
import static com.dawn.constant.RedisConstant.*;
import static com.dawn.enums.UserAreaTypeEnum.getUserAreaType;
import static com.dawn.util.CommonUtil.checkEmail;
import static com.dawn.util.CommonUtil.getRandomCode;
...
public class UserAuthServiceImpl implements UserAuthService {
    ...
    public void register(UserVO userVO) {
        ...
        UserInfo userInfo = UserInfo.builder()
                ...
                .avatar(dawnInfoService.getWebsiteConfig().getUserAvatar())
                .build();
