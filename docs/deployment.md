...
```shell
docker run --name elasticsearch -p 9200:9200 -p 9300:9300 -e "discovery.type=single-node" -e ES_JAVA_OPTS="-Xms64m -Xmx128m" -v D:/programing/docker/elasticsearch/config/elasticsearch.yml:/usr/shellare/elasticsearch/config/elasticsearch.yml -v D:/programing/docker/elasticsearch/data:/usr/shellare/elasticsearch/data -v D:/programing/docker/elasticsearch/plugins:/usr/shellare/elasticsearch/plugins -d elasticsearch:7.9.2
```
